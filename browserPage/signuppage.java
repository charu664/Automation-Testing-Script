...
public class signuppage {
    ...
    static WebElement promo;
    @FindBy(xpath="//input[@class='ant-checkbox-input']")
    static WebElement checkbox;
    //  @FindBy(xpath = "//button[@class=\"ant-btn css-1b0bdye ant-btn-primary ant-btn-lg\"]")
//  WebElement button;
...
//    WebElement Mt5account;
    ...
    public static void getStared(){getStared.click();}
    public static void enterfirstname() {firstName.sendKeys("Vipual");}
    public static void enterlastname() {lastName.sendKeys("jadhav");}
    public static void enterEmail() {email.sendKeys("vipual@gmail.com");}
    public static void enternumber() {phonenumber.sendKeys("9908736354");}
    public static void country(){country.click();}
    public static void clickcountry(){countryname.click();}
    public static void enterPasswrod() {password.sendKeys("Vipual#10");}
    public static void enterpromo() {promo.sendKeys("0");}
    public static void clickcheckbox() {checkbox.click();}
//        public void button() {button.click();}
//        public void useremail() {useremail.sendKeys("Vipual@gmail.com");}
//        public void userpassword() {userpassword.sendKeys("Vipual#10");}
...
//        public void Useremail(){Useremail.click();}
//        public void userpassword1(){userpassword1.click();}
